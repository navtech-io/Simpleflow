...
internal partial class SimpleflowParserBaseListener : ISimpleflowParserListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterIndexNumber([NotNull] SimpleflowParser.IndexNumberContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="SimpleflowParser.indexNumber"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitIndexNumber([NotNull] SimpleflowParser.IndexNumberContext context) { }
	/// <summary>
